...
class YogaPoseCard(BoxLayout):
    def __init__(self, pose_name, pose_data, **kwargs):
        ...
        self.height = 350  # Taller for image
        ...
        if 'image_path' in pose_data:
            print("Looking for image:", pose_data['image_path'], os.path.exists(pose_data['image_path']))
            if os.path.exists(pose_data['image_path']):
                pose_image = Image(
                    source=pose_data['image_path'],
                    size_hint_y=None,
                    height=150,
                    allow_stretch=True,
                    keep_ratio=True
                )
                self.add_widget(pose_image)
...
class YogaMobileApp(App):
    ...
    def load_music(self):
        """Load relax music from yoga_music folder"""
        music_path = os.path.join("yoga_music", "Relax Music.mp3")
        if os.path.exists(music_path):
            try:
                self.music_sound = SoundLoader.load(music_path)
                if self.music_sound:
    ...
    def play_music(self):
        ...
        if self.music_sound and not self.music_playing:
            try:
                ...
                print("🎵 Relax music started")
            except Exception as e:
                print(f"❌ Error playing music: {e}")
    
    def stop_music(self):
        """Stop relax music"""
        if self.music_sound and self.music_playing:
            try:
    ...
    def build(self):
        ...
        # Music controls
        music_controls = BoxLayout(size_hint_y=None, height=50, spacing=10)
        
        play_btn = Button(
            text="🎵 Play Music",
            font_size='14sp',
            on_press=lambda x: self.play_music(),
            size_hint_x=0.5
        )
        music_controls.add_widget(play_btn)
        
        stop_btn = Button(
            text="🔇 Stop Music",
            font_size='14sp',
            on_press=lambda x: self.stop_music(),
            size_hint_x=0.5
        )
        music_controls.add_widget(stop_btn)
        
        title_bar.add_widget(music_controls)
    ...
    def yoga_poses(self):
        """Get yoga poses with local image paths"""
        poses_dir = "Yoga Poses"
        ...
        return {
            "Plank Pose (Phalakasana)": {
                ...
                "difficulty": "Beginner",
                "emoji": "🦾",
                "image_path": os.path.join(poses_dir, "Plank.jpg")
            },
            "Boat Pose (Navasana)": {
                ...
                "emoji": "🚣",
                "image_path": os.path.join(poses_dir, "Navasana Pose.jpg")
            },
            "Cobra Pose (Bhujangasana)": {
                ...
                "difficulty": "Beginner",
                "emoji": "🐍",
                "image_path": os.path.join(poses_dir, "Bhujangasana.jpg")
            },
            "Bridge Pose (Setu Bandhasana)": {
                ...
                "difficulty": "Beginner",
                "emoji": "🌉",
                "image_path": os.path.join(poses_dir, "Setu Bandhasana.jpg")
            },
            "Warrior III (Virabhadrasana III)": {
                ...
                "difficulty": "Intermediate",
                "emoji": "⚔️",
                "image_path": os.path.join(poses_dir, "Virabhadrasana.jpg")
            },
            "Side Plank (Vasisthasana)": {
                ...
                "difficulty": "Intermediate",
                "emoji": "⚖️",
                "image_path": os.path.join(poses_dir, "Vasisthasana.jpg")
            },
            "Crow Pose (Bakasana)": {
                ...
                "difficulty": "Advanced",
                "emoji": "🦅",
                "image_path": os.path.join(poses_dir, "Bakasana.jpg")
            },
            "Cat-Cow Stretch (Marjaryasana-Bitilasana)": {
                ...
                "difficulty": "Beginner",
                "emoji": "🐱🐄",
                "image_path": os.path.join(poses_dir, "Marjarasana.jpg")
            }
        }
...
🎵 Play relax music during your practice!
        """
...
🎵 Tip: Listen to relax music while preparing meals!
        """
