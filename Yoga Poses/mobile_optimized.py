...
class TimerPopup(Popup):
    def __init__(self, pose_name, duration, **kwargs):
        ...
        self.size_hint = (0.9, 0.7)  # Larger popup
        ...
        self.progress_bar = ProgressBar(
            ...
            value=0,
            size_hint_y=None,
            height=40  # Larger progress bar
        )
        layout.add_widget(self.progress_bar)
        
        # Controls
        controls = BoxLayout(size_hint_y=None, height=80, spacing=20)  # Larger buttons
...
class YogaPoseCard(BoxLayout):
    def __init__(self, pose_name, pose_data, **kwargs):
        ...
        self.padding = 25  # More padding
        self.spacing = 15   # More spacing
        self.size_hint_y = None
        self.height = 280   # Taller cards
        ...
        # Pose emoji and name
        header = BoxLayout(size_hint_y=None, height=60)  # Taller header
        emoji_label = Label(
        ...
        desc_label = Label(
            ...
            size_hint_y=None,
            height=70,  # More space for description
            text_size=(Window.width - 80, None),
            halign='left',
            valign='top',
            font_size='16sp'  # Larger description text
        )
        ...
        details_label = Label(
            ...
            height=40,
            color=(0.5, 0.5, 0.5, 1),
            font_size='14sp'  # Larger details text
        )
        self.add_widget(details_label)
        
        # Buttons
        buttons = BoxLayout(size_hint_y=None, height=70, spacing=15)  # Larger buttons
        
        timer_btn = Button(
            text="⏱️ Timer",
            font_size='18sp',  # Larger button text
    ...
    def show_info(self, pose_name, pose_data):
        ...
        popup = Popup(
            ...
            content=content,
            size_hint=(0.95, 0.9)  # Larger popup
        )
        popup.open()
...
class YogaMobileApp(App):
    def build(self):
        ...
        Window.size = (400, 800)  # Taller for mobile
        ...
        tip_label = Label(
            ...
            font_size='14sp',  # Larger subtitle
            color=(0.8, 0.8, 0.8, 1),
            size_hint_y=None,
            height=40
        )
        ...
        grid = GridLayout(
            cols=1,
            spacing=20,  # More spacing between cards
            size_hint_y=None,
            padding=[15, 15]  # More padding
        )
...
⏰ OPTIMAL: Morning or evening
        ...
        routine_label = Label(
            text=routine_text,
            size_hint_y=None,
            height=500,  # More space
            text_size=(Window.width - 100, None),
            halign='left',
            valign='top',
            font_size='16sp'  # Larger text
        )
