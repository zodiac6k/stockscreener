    ...
    def yoga_poses(self):
        ...
        return {
            ...
            "Boat Pose (Navasana)": {
                ...
                "emoji": "🚣",
                "image_path": os.path.join(poses_dir, "Nvasana Pose.jpg")
            },
            ...
            "Bridge Pose (Setu Bandhasana)": {
                ...
                "difficulty": "Beginner",
                "emoji": "🌉",
                "image_path": os.path.join(poses_dir, "Setu Bhandasana.jpg")
            },
            ...
            "Side Plank (Vasisthasana)": {
                ...
                "difficulty": "Intermediate",
                "emoji": "⚖️",
                "image_path": os.path.join(poses_dir, "Vashistasana.jpg")
            },
            "Crow Pose (Bakasana)": {
